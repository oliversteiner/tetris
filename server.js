...
var params = {
  ...
  host: "127.0.0.1", // Set the address to bind to. Defaults to 0.0.0.0 or
                     // process.env.IP.
  ...
  // mount: [['/components', './node_modules']], // Mount a directory to a
  // route.
  logLevel: 2, // 0 = errors only, 1 = some, 2 = lots
  middleware: [function (req, res, next) {
    next();
  }] // Takes an array of Connect-compatible middleware that are injected into
     // the server middleware stack
};
